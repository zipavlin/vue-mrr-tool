...
/* harmony default export */ var MrrToolvue_type_script_lang_js_ = ({
    ...
    mounted() {
        ...
        // mobile listeners
            ...
            const recognizers = [];
            if (this.mOptions.move) recognizers.push([hammer_default.a.Pan, { direction: hammer_default.a.DIRECTION_ALL }]);
            if (this.mOptions.resize) recognizers.push([hammer_default.a.Pinch]);
            recognizers.push([hammer_default.a.Press]);
            const moveResizeManager = new hammer_default.a.Manager(this.$refs.move, { recognizers });
            // move
            if (this.mOptions.move) {
    ...
    methods: {
        addPanListener(element, changes, mOptions, name) {
            ...
            const manager = new hammer_default.a.Manager(element, {recognizers: [[hammer_default.a.Pan]]});
...
// CONCATENATED MODULE: ./src/MrrTool.vue
...
/******/ })["default"];
//# sourceMappingURL=MrrTool.common.js.map